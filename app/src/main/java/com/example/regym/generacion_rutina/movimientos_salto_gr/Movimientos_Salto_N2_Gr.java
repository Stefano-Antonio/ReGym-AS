...
public class Movimientos_Salto_N2_Gr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Regresar_btn.setOnClickListener(v -> {
            Intent intent = new Intent(com.example.regym.generacion_rutina.movimientos_salto_gr.Movimientos_Salto_N2_Gr.this, Mostrar_Niveles_Salto_Gr.class);
        ...
        Generar_btn.setOnClickListener(v -> {
                ...
                if (switches[i].isChecked()) {
                    ...
                    switch (i + 1) {
                        case 1:
                            ...
                            aparato.append("-Elevaciones de Piernas Colgando-Realiza 3 series de 12 elevaciones de piernas. \n");
                            acondicionamiento.append("-Flic-Flac Extendido-Practica 3 series de 10 repeticiones de flic-flac extendido.\n ");
                            break;
                    }
                }
            }
            ...
            if (switchChecked) {
                Intent intent = new Intent(com.example.regym.generacion_rutina.movimientos_salto_gr.Movimientos_Salto_N2_Gr.this, Rutina_Generada.class);
            ...
            if (!switchChecked) {
                Toast.makeText(com.example.regym.generacion_rutina.movimientos_salto_gr.Movimientos_Salto_N2_Gr.this, "Activa un Switch para generar la rutina", Toast.LENGTH_SHORT).show();
            }
        });
    }
}