...
public class Movimientos_Viga_N3_Gr extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.movimientos_viga_n3_gr);
        ...
        Regresar_btn.setOnClickListener(v -> {
            Intent intent = new Intent(com.example.regym.generacion_rutina.movimientos_viga_gr.Movimientos_Viga_N3_Gr.this, Mostrar_Niveles_Salto_Gr.class);
        ...
        Generar_btn.setOnClickListener(v -> {
                ...
                if (switches[i].isChecked()) {
                    ...
                    switch (i + 1) {
                        ...
                        case 2:
                            ...
                            acondicionamiento.append("-Parada de Manos-Practica 3 series de 8 repeticiones de parada de manos transversal en la viga. \n");
                            break;
                        case 3:
                            fortalecimiento.append("-Elevaciones de Pantorrillas-Realiza 3 series de 15 elevaciones de pantorrillas. \n");
                            aparato.append("-Sentadillas-Realiza 3 series de 15 sentadillas. \n");
                            acondicionamiento.append("-Equilibrio en Relevé-Practica 3 series de 10 repeticiones de equilibrio en relevé en la viga.\n");
                            break;
                        case 4:
                        ...
                        case 5:
                            ...
                            acondicionamiento.append("-Arabesca-Practica 3 series de 10 repeticiones de arabesca a 45º en la viga.\n ");
                            break;
                        case 6:
                            fortalecimiento.append("-Sentadillas-Realiza 3 series de 15 sentadillas. \n");
                            aparato.append("-Estocadas-Realiza 3 series de 12 estocadas por pierna. \n");
                            acondicionamiento.append("-Salto Leap Split-Practica 3 series de 8 repeticiones de salto leap split con piernas extendidas a 90º en la viga.\n");
                            break;
                        case 7:
                            fortalecimiento.append("-Flexiones de Brazos-Realiza 3 series de 12 flexiones. \n");
                            aparato.append("-Plancha-Mantén la posición de plancha durante 45-60 segundos.\n");
                            acondicionamiento.append("-Giros Pivote-Practica 3 series de 8 repeticiones de giros pivote a 180º en la viga. \n");
                            break;
                        case 8:
                            fortalecimiento.append("-Flexiones de Brazos-Realiza 3 series de 12 flexiones. \n");
                            aparato.append("-Plancha-Mantén la posición de plancha durante 45-60 segundos. \n");
            ...
            if (switchChecked) {
                Intent intent = new Intent(com.example.regym.generacion_rutina.movimientos_viga_gr.Movimientos_Viga_N3_Gr.this, Rutina_Generada.class);
            ...
            if (!switchChecked) {
                Toast.makeText(com.example.regym.generacion_rutina.movimientos_viga_gr.Movimientos_Viga_N3_Gr.this, "Activa un Switch para generar la rutina", Toast.LENGTH_SHORT).show();
            }
        });
    }
}