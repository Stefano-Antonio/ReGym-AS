...
public class Movimientos_Salto_N3_Gr extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.movimientos_salto_n3_gr);
        ...
        Regresar_btn.setOnClickListener(v -> {
            Intent intent = new Intent(com.example.regym.generacion_rutina.movimientos_salto_gr.Movimientos_Salto_N3_Gr.this, Mostrar_Niveles_Salto_Gr.class);
        ...
        Generar_btn.setOnClickListener(v -> {
                ...
                if (switches[i].isChecked()) {
                    ...
                    switch (i + 1) {
                        case 1:
                            ...
                            acondicionamiento.append("-Salto de Caballo Avanzado-Practica 3 series de 8 repeticiones de salto de caballo avanzado.\n ");
                            break;
                    }
                }
            }
            ...
            if (switchChecked) {
                Intent intent = new Intent(com.example.regym.generacion_rutina.movimientos_salto_gr.Movimientos_Salto_N3_Gr.this, Rutina_Generada.class);
            ...
            if (!switchChecked) {
                Toast.makeText(com.example.regym.generacion_rutina.movimientos_salto_gr.Movimientos_Salto_N3_Gr.this, "Activa un Switch para generar la rutina", Toast.LENGTH_SHORT).show();
            }
        });
    }
}