...
public class Movimientos_Salto_N4_Mg extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {

        super.onCreate(savedInstanceState);
        setContentView(R.layout.movimientos_salto_n4_mg);
...
//Boton regresar
        Regresar_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(com.example.regym.manual_gimnasia.movimientos_salto_mg.Movimientos_Salto_N4_Mg.this, Mostrar_Niveles_Piso_Mg.class);
...
//Boton Movimiento1
        Movimiento1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(com.example.regym.manual_gimnasia.movimientos_salto_mg.Movimientos_Salto_N4_Mg.this, Movimiento_Pantalla.class);
                intent.putExtra("movimiento_gift", R.raw.m1_n4_salto);  // Recurso del GIF
                intent.putExtra("tabla_imagen", R.drawable.tabla_salto_n4_m1);  // Recurso de la tabla
                ...
                intent.putExtra("informacion_ayuda", "Las series de saltos pueden ser exigentes físicamente y aumentar el riesgo de fatiga y lesiones.\n" +
                        "Consejo: Asegúrate de calentar adecuadamente antes de realizar series de saltos y escucha a tu cuerpo.");  // Texto de descripción
                intent.putExtra("link","https://www.youtube.com/watch?v=OGfX_n_Hu0U&ab_channel=PROFE-WILSON");
                intent.putExtra("mov","S_n1_m1");
                intent.putExtra("titulo", "SALTO N4");
                startActivity(intent);
            }
        });
    }
