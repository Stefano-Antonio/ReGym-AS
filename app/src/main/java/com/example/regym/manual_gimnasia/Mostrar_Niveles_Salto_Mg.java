...
import com.example.regym.manual_gimnasia.movimientos_salto_mg.Movimientos_Salto_N1_Mg;
import com.example.regym.manual_gimnasia.movimientos_salto_mg.Movimientos_Salto_N2_Mg;
import com.example.regym.manual_gimnasia.movimientos_salto_mg.Movimientos_Salto_N3_Mg;
import com.example.regym.manual_gimnasia.movimientos_salto_mg.Movimientos_Salto_N4_Mg;
import com.example.regym.manual_gimnasia.movimientos_salto_mg.Movimientos_Salto_N5_Mg;
        ...
        Regresar_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (tipoUsuario != "Atletas") {
                    ...
                    Intent intent = new Intent(Mostrar_Niveles_Salto_Mg.this, Pantalla_Inicio_Atletas.class);
                    startActivity(intent);
                } else {
