...
import com.example.regym.manual_gimnasia.movimientos_barra_mg.Movimientos_Barra_N1_Mg;
import com.example.regym.manual_gimnasia.movimientos_barra_mg.Movimientos_Barra_N2_Mg;
import com.example.regym.manual_gimnasia.movimientos_barra_mg.Movimientos_Barra_N3_Mg;
import com.example.regym.manual_gimnasia.movimientos_barra_mg.Movimientos_Barra_N4_Mg;
import com.example.regym.manual_gimnasia.movimientos_barra_mg.Movimientos_Barra_N5_Mg;

public class Mostrar_Niveles_Barra_Mg extends AppCompatActivity {
    @Override
        ...
        Regresar_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tipoUsuario != "Atletas") {
                    ...
                    Intent intent = new Intent(Mostrar_Niveles_Barra_Mg.this, Pantalla_Inicio_Atletas.class);
                    startActivity(intent);
                } else {
                    Log.d("TipoUsuario", "Tipo de usuario no recibido");
                    Intent intent = new Intent(Mostrar_Niveles_Barra_Mg.this, Manual_Gimnasia.class);
                    startActivity(intent);
                }
            }
        });
